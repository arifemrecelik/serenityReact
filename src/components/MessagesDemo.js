            ...
            <div className="ui-g">
                <div className="ui-g-12">
                    <div className="card">
                        ...
                        <Button onClick={this.showWarn} label="Warn" className="amber-btn" style={{width:'100px'}}/>
                        <Button onClick={this.showError} label="Error" className="red-btn" style={{width:'100px'}}/>
                    </div>

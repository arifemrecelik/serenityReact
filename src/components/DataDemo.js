    ...
    pickListTemplate(car){
        ...
        return (
            <div className="ui-helper-clearfix">
                <img src={`assets/demo/images/car/${car.brand}.png`} alt={car.brand} style={{display:'inline-block', margin:'2px 0 2px 2px', width: '48px'}}/>
                <div style={{fontSize:'16px', float:'right', margin:'20px 5px 0 0'}}>{car.brand}</div>
            </div>
        );
    }
        ...
        return (
            <div className="ui-g">
                ...
                <div className="ui-g-12 ui-md-8">
                    <div className="card card-w-title">
                        ...
                        <PickList source={this.state.picklistSourceCars} target={this.state.picklistTargetCars} sourceHeader="Available" targetHeader="Selected"
                                        responsive={true} itemTemplate={this.pickListTemplate} sourceStyle={{height:'250px'}} targetStyle={{height: '250px'}}
                ...
                <div className="ui-g-12 ui-md-4">
                    <div className="card card-w-title">
                        <h1>OrderList</h1>
                        <OrderList  value={this.state.orderlistCars} responsive={true} header="OrderList" listStyle={{height: '250px'}}

            ...
            <div className="ui-g">
                <div className="ui-g-12">
                    <div className="card docs">
                        ...
                        <p>Serenity is an application template for React, based on the popular <a href="https://github.com/facebookincubator/create-react-app">create-react-app</a> which allows
...
&lt;div className="layout-wrapper layout-wrapper-static"&gt;
                        ...
                        <h1>Utilites</h1>
                        <p>Serenity provides various helper features such as material iconset compatible with PrimeNG components and helper classes. Visit utils page for details.</p>
                                
                        <h1>Grid CSS</h1>
                        <p>Serenity uses PrimeReact Grid CSS (ui-g-*) throughout the samples, although any Grid library can be used we suggest using Grid CSS as your layout framework as it is well tested and supported by PrimeReact. Grid CSS is

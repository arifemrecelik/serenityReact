    ...
    render() {
        ...
        return <div className="ui-g dashboard">
            ...
            <div className="ui-g-12 ui-md-6 ui-lg-4 task-list">
                <Panel header="Tasks">
                    <Button icon="ui-icon-menu" className="secondary-btn"  onClick={(event) => this.menu.toggle(event)}/>
            ...
            <div className="ui-g-12 ui-md-6 ui-lg-4 ui-fluid contact-form">
                <Panel header="Contact Us">
                    ...
                    <Button type="button" label="Send" icon="ui-icon-send"></Button>
                </Panel>
            </div>
            <div className="ui-g-12 ui-lg-4 messages">
                        ...
                        <li>
                            <div>
                                <img src="assets/layout/images/avatar1.png" width="45" alt="avatar1"/>
                                    ...
                                    <Button icon="ui-icon-close" title="Reply" className="remove-btn"></Button>
                                    <Button icon="ui-icon-message" title="Reply" className="message-btn secondary-btn"></Button>
                            </div>
                        </li>
                        <li>
                            <div>
            ...
            <div className="ui-g-12 ui-lg-6 ui-g-nopad">
                <div className="ui-g-12 chat">
                    <Panel header="Chat">
                        <TabView>
                ...
                <div className="ui-g-12 status-bars">
                    <div className="card">
                        <ul>
                            <li>
            ...
            <div className="ui-g-12 ui-lg-6 ui-g-nopad">
                <div className="ui-g-12 global-sales">
                ...
                <div className="ui-g-12 image-box">
                    <div className="card">
                        ...
                        <div className="image-box-content">
                            ...
                            <div className="image-box-footer">
                                <Button icon="ui-icon-close" title="Close" label="Close" className="remove-btn orange-btn" style={{marginRight:'4px'}}></Button>
                                <Button icon="ui-icon-add" title="New" label="New" className="message-btn secondary-btn"></Button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="ui-g-12 ui-md-8">
                <div className="card">
                    <DataTable value={this.state.cars} selectionMode="single" header="Recent Sales" style={{marginBottom: '20px'}}
                               selection={this.state.dataTableSelectValue} onSelectionChange={(e) => this.setState({dataTableSelectValue: e.data})}>
                ...
                <div className="ui-g-12">
                    <div className="user-card card">
                        ...
                        <div className="user-card-content">
                            <img src="assets/layout/images/avatar.png" alt="serenity-layout" />
                            <Button icon="ui-icon-settings" className="secondary-btn"></Button>
